...
import kotlinx.android.synthetic.main.activity_editarfotos.*
import kotlinx.android.synthetic.main.fragment_profile.*

class editarFotosPerfilActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_editarfotos)
        ...
        imgFoto1Editar.setOnClickListener{
            //Show image
            foto = 2
            imagePickDialog()
        }

        imgFoto2Editar.setOnClickListener{
            //Show image
            foto = 3
            imagePickDialog()
        }

        imgFoto3Editar.setOnClickListener{
            //Show image
            foto = 4
            imagePickDialog()
        }

        btnSalvarFotos.setOnClickListener {
            uploadImages()
        }
        ...
        if(resultCode == RESULT_OK) {
            ...
            if(requestCode == IMAGE_PICK_GALLERY_CODE) {
                ...
                if(resultCode == Activity.RESULT_OK) {
                    ...
                    when(foto) {
                        1 -> {
                            imgPerfilEditar.setImageURI(resultUri)
                            imageUri1 = imageUri
                        }
                        2 -> {
                            imgFoto1Editar.setImageURI(resultUri)
                            imageUri2 = imageUri
                        }
                        3 -> {
                            imgFoto2Editar.setImageURI(resultUri)
                            imageUri3 = imageUri
                        }
                        4 -> {
                            imgFoto3Editar.setImageURI(resultUri)
                            imageUri4 = imageUri
                        }
                    }
